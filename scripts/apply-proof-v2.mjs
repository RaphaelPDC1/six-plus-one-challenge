...
if (!source.includes("function ProofV2TopLayer")) {
...
if (!source.includes('data-testid="proof-page-v2-with-normal-feed"')) {
  if (!source.includes(oldReturnStart)) {
    throw new Error("Expected ProofFeed return block was not found.");
  }
  source = source.replace(oldReturnStart, newReturnStart);
