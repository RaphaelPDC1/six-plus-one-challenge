...
function Overview({ snapshot }: { snapshot: Snapshot }) {
  ...
  return (
    <div className="motion-page space-y-4 overflow-hidden" data-testid="overview-metrics-dashboard">
      <section className="relative overflow-hidden rounded-[1.6rem] border border-[#2A2A2A] bg-[#0F0F0F] p-4 shadow-[0_0_50px_rgba(0,0,0,0.35)] sm:p-5" data-testid="overview-red-alert-pace-card">
