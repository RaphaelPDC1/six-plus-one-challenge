...
describe("Home onboarding shell", () => {
  ...
  it("keeps the six-rule log framed as a must-do checklist with compact feedback and locked Ghost Life hooks", () => {
    ...
    expect(homeSource).toContain("mb-3 min-w-0 max-w-full overflow-hidden border");
    expect(homeSource).toContain("flex max-w-full snap-x gap-1 overflow-x-auto overscroll-x-contain");
    expect(homeSource).toContain("min-w-[5.75rem] max-w-[7.25rem] flex-[0_0_5.75rem] snap-start overflow-hidden");
