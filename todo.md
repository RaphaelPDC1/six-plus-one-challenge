...
- [x] Correct the latest update/release label so the PWA notification work is recorded as an edit rather than a Community Care category update. Updated release-note category support, admin copy, participant popup labeling, the current database row, and release-note tests.
...
- [x] Bug: My Day excessive re-fetching causing crashes — stabilise query refs and add caching.
